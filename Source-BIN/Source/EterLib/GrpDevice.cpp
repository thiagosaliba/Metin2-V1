...
#if defined(__VERTEX_BUFFER_PERFORMANCE__)
	if (ms_lpd3dTextLinePDTVB)
	{
		ms_lpd3dTextLinePDTVB->Release();
		ms_lpd3dTextLinePDTVB = nullptr;
	}
#endif
}
...
#if defined(__VERTEX_BUFFER_PERFORMANCE__)
	if (FAILED(ms_lpd3dDevice->CreateVertexBuffer(sizeof(TPDTVertex) * PDT_TEXTLINE_VERTEX_NUM, D3DUSAGE_DYNAMIC | D3DUSAGE_WRITEONLY, D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_TEX1, D3DPOOL_SYSTEMMEM, &ms_lpd3dTextLinePDTVB)))
		return false;
#endif
