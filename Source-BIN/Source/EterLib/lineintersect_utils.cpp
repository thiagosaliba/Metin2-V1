...
*
* Purpose:
*	Given two lines (segments) that are known to be parallel, find
...
*
* Purpose:
*	Given nearest point information for two infinite lines, adjust
...
*
* Purpose:
*	Find the nearest point between two finite length line segments
...
*
* Purpose:
*	Given a line (segment) and a point in 3-dimensional space,
...
*					parameter = 1 at the second defining point of the line/segmetn
*
*/
