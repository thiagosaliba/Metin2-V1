...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
int CEffectManager::CreateEffect(DWORD dwID, const D3DXVECTOR3& c_rv3Position, const D3DXVECTOR3& c_rv3Rotation, float fParticleScale, DWORD* dwSkillColor)
#else
...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
	CreateEffectInstance(iInstanceIndex, dwID, fParticleScale, NULL, dwSkillColor);
#else
...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
void CEffectManager::CreateEffectInstance(DWORD dwInstanceIndex, DWORD dwID, float fParticleScale, const D3DXVECTOR3* c_pv3MeshScale, DWORD* dwSkillColor)
#else
