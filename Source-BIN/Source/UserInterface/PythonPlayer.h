...
public:
	...
	void SetStatus(DWORD dwType, long long llValue);
	...
	// Acce
	void SetAcceRefineWindowOpen(BYTE bSet) { m_isOpenAcceRefineWindow = bSet; };
	BOOL GetAcceRefineWindowOpen() { return m_isOpenAcceRefineWindow; }
#endif
...
public:
	...
	void SetChangeLookItemData(TPacketGCChangeLookSet& rData);
	...
	void SetChangeLookFreeItemData(TPacketGCChangeLookSet& rData);
