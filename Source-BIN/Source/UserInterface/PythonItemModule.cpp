...
PyObject* itemGetAffect(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (CItemData::APPLY_MOUNT == ItemApply.bType)
...
#if defined(ENABLE_ACCE_COSTUME_SYSTEM)
		if (CPythonAcce::Instance().IsCleanScroll(iItemIndex))
			return Py_BuildValue("i", TRUE);
#endif
...
PyObject* itemIsSealScroll(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (iItemIndex == CItemData::SEAL_ITEM_BINDING_VNUM || iItemIndex == CItemData::SEAL_ITEM_UNBINDING_VNUM)
		return Py_BuildValue("i", true);
...
{
	return Py_BuildValue("i", CItemData::SEAL_DATE_UNLIMITED_TIMESTAMP);
}

PyObject* itemGetItemUnSealLeftTime(PyObject* poSelf, PyObject* poArgs)
{
...
PyObject* itemIsPetUpbringing(PyObject* poSelf, PyObject* poArgs)
{
	int iItemIndex;
	if (!PyTuple_GetInteger(poArgs, 0, &iItemIndex))
		return Py_BadArgument();
...
PyObject* itemIsItemUsedForDragonSoul(PyObject* poSelf, PyObject* poArgs)
{
	...
	case 2:
	{
		...
		if (pItemData->GetType() == CItemData::ITEM_TYPE_EXTRACT)
		{
			switch (pItemData->GetSubType())
			{
			case CItemData::EXTRACT_DRAGON_SOUL:
			case CItemData::EXTRACT_DRAGON_HEART:
				return Py_BuildValue("i", true);
			}
		}
...
void initItem()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetItemUnSealLeftTime", itemGetItemUnSealLeftTime, METH_VARARGS },
#endif
		...
		{ "IsPetUpbringing", itemIsPetUpbringing, METH_VARARGS },
	...
	PyModule_AddIntConstant(poModule, "APPLY_ENCHANT_ELEC", CItemData::APPLY_ENCHANT_ELECT);
	...
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_SWORD_REDUCTION", CItemData::APPLY_ATTBONUS_SWORD);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_TWOHAND_REDUCTION", CItemData::APPLY_ATTBONUS_TWOHAND);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_DAGGER_REDUCTION", CItemData::APPLY_ATTBONUS_DAGGER);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_BELL_REDUCTION", CItemData::APPLY_ATTBONUS_BELL);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_FAN_REDUCTION", CItemData::APPLY_ATTBONUS_FAN);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_BOW_REDUCTION", CItemData::APPLY_ATTBONUS_BOW);
	PyModule_AddIntConstant(poModule, "APPLY_RESIST_CLAW_REDUCTION", CItemData::APPLY_ATTBONUS_CLAW);
	...
	PyModule_AddIntConstant(poModule, "ADD_RARE_ATTRIBUTE_VNUM", CItemData::ADD_RARE_ATTRIBUTE_VNUM);
	PyModule_AddIntConstant(poModule, "CHANGE_RARE_ATTRIBUTE_VNUM", CItemData::CHANGE_RARE_ATTRIBUTE_VNUM);
#endif
}
