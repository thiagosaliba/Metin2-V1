...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "MOTION_PUSH_UP", CRaceMotionData::NAME_PUSH_UP);
	...
	PyModule_AddIntConstant(poModule, "MOTION_NOSAY", CRaceMotionData::NAME_NOSAY);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER1", CRaceMotionData::NAME_WEATHER1);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER2", CRaceMotionData::NAME_WEATHER2);
	PyModule_AddIntConstant(poModule, "MOTION_WEATHER3", CRaceMotionData::NAME_WEATHER3);
	PyModule_AddIntConstant(poModule, "MOTION_HUNGRY", CRaceMotionData::NAME_HUNGRY);
	PyModule_AddIntConstant(poModule, "MOTION_SIREN", CRaceMotionData::NAME_SIREN);
	PyModule_AddIntConstant(poModule, "MOTION_LETTER", CRaceMotionData::NAME_LETTER);
	PyModule_AddIntConstant(poModule, "MOTION_CALL", CRaceMotionData::NAME_CALL);
	PyModule_AddIntConstant(poModule, "MOTION_CELEBRATION", CRaceMotionData::NAME_CELEBRATION);
	PyModule_AddIntConstant(poModule, "MOTION_ALCOHOL", CRaceMotionData::NAME_ALCOHOL);
	PyModule_AddIntConstant(poModule, "MOTION_BUSY", CRaceMotionData::NAME_BUSY);
	...
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_1", CInstanceBase::AFFECT_BLEND_POTION_1);
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_2", CInstanceBase::AFFECT_BLEND_POTION_2);
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_3", CInstanceBase::AFFECT_BLEND_POTION_3);
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_4", CInstanceBase::AFFECT_BLEND_POTION_4);
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_5", CInstanceBase::AFFECT_BLEND_POTION_5);
	PyModule_AddIntConstant(poModule, "AFFECT_BLEND_POTION_6", CInstanceBase::AFFECT_BLEND_POTION_6);
	PyModule_AddIntConstant(poModule, "AFFECT_ENERGY", CInstanceBase::AFFECT_ENERGY);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGON_GOD_1", CInstanceBase::AFFECT_DRAGON_GOD_1);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGON_GOD_2", CInstanceBase::AFFECT_DRAGON_GOD_2);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGON_GOD_3", CInstanceBase::AFFECT_DRAGON_GOD_3);
	PyModule_AddIntConstant(poModule, "AFFECT_DRAGON_GOD_4", CInstanceBase::AFFECT_DRAGON_GOD_4);
	PyModule_AddIntConstant(poModule, "AFFECT_CRITICAL", CInstanceBase::AFFECT_CRITICAL);
	PyModule_AddIntConstant(poModule, "AFFECT_PENETRATE", CInstanceBase::AFFECT_PENETRATE);
	PyModule_AddIntConstant(poModule, "AFFECT_ATTACK_SPEED", CInstanceBase::AFFECT_ATTACK_SPEED);
	PyModule_AddIntConstant(poModule, "AFFECT_MOVE_SPEED", CInstanceBase::AFFECT_MOVE_SPEED);
#endif

	PyModule_AddIntConstant(poModule, "AFFECT_RESEARCHER_ELIXIR", CInstanceBase::AFFECT_RESEARCHER_ELIXIR);
