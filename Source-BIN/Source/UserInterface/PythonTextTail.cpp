...
#endif
{
	...
	if (!prLanguage)
	{
		BYTE byLanguage = pCharacterInstance->GetLanguage();
		if (pCharacterInstance->IsPC() && byLanguage)
		{
			std::string strCode = "en";
			switch (byLanguage)
			{
			case CPythonApplication::LOCALE_EN: strCode = "en"; break;
			case CPythonApplication::LOCALE_PT: strCode = "pt"; break;
			case CPythonApplication::LOCALE_ES: strCode = "es"; break;
			case CPythonApplication::LOCALE_FR: strCode = "fr"; break;
			case CPythonApplication::LOCALE_GR: strCode = "gr"; break;
			case CPythonApplication::LOCALE_DE: strCode = "de"; break;
			case CPythonApplication::LOCALE_RO: strCode = "ro"; break;
			case CPythonApplication::LOCALE_PL: strCode = "pl"; break;
			case CPythonApplication::LOCALE_IT: strCode = "it"; break;
			case CPythonApplication::LOCALE_CZ: strCode = "cz"; break;
			case CPythonApplication::LOCALE_HU: strCode = "hu"; break;
			case CPythonApplication::LOCALE_TR: strCode = "tr"; break;
			default: strCode = "kr"; break;
			}

			char szFileName[256];
			sprintf(szFileName, "icon/locale_flag/%s.png", strCode.c_str());
