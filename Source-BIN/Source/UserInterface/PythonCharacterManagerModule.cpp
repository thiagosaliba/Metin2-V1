...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_MAGIC_RING_EQUIP", CInstanceBase::EFFECT_MAGIC_RING_EQUIP);
	...
	PyModule_AddIntConstant(poModule, "EFFECT_NAZAR_PENDANT", CInstanceBase::EFFECT_NAZAR_PENDANT);
	PyModule_AddIntConstant(poModule, "EFFECT_GUARDIAN_PENDANT", CInstanceBase::EFFECT_GUARDIAN_PENDANT);
	...
	PyModule_AddIntConstant(poModule, "EFFECT_DRAGONLAIR_STONE_UNBEATABLE_4", CInstanceBase::EFFECT_DRAGONLAIR_STONE_UNBEATABLE_4);
#endif
