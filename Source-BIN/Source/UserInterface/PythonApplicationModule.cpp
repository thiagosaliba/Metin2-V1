...
PyObject* appGetPatch(PyObject* poSelf, PyObject* poArgs)
{
	char szBuffer[128 + 1];
	sprintf(szBuffer, "Patch %d", PATCH);
	return Py_BuildValue("s", szBuffer);
}
...
void initapp()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetPatch", appGetPatch, METH_VARARGS },
...
#ifdef DISABLE_WOLFMAN_CREATION
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BLEND_AFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BLEND_AFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_AFK_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AFK_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EMOTION_HIDE_WEAPON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EMOTION_HIDE_WEAPON", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SOUL_BIND_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SOUL_BIND_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_BLEND_AFFECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_EXTENDED_BLEND_AFFECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_PICKUP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_QUICK_PICKUP", 0);
#endif
...
#ifdef ENABLE_DSS_EXTENDED_RECHARGE
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_EXTENDED_RECHARGE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DSS_EXTENDED_RECHARGE", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SOCKET5", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_SOCKET5", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_IMAGE_CLIP_RECT", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_IMAGE_CLIP_RECT", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_67TH_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_67TH_BONUS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_STATUS_UPDATE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CHANNEL_STATUS_UPDATE", 0);
#endif
...
#if defined(ENABLE_SORT_INVENTORY)
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SORT_INVENTORY", 0);
#endif

#if defined(ENABLE_OSF_MINIMAP_INFO)
	PyModule_AddIntConstant(poModule, "ENABLE_OSF_MINIMAP_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OSF_MINIMAP_INFO", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "PATCH", PATCH);
}
