...
public:
	...
	enum EName
	{
		...
		NAME_DANCE_1, // (dance_1.msa)
		NAME_DANCE_2, // (dance_2.msa)
		NAME_DANCE_3, // (dance_3.msa)
		NAME_DANCE_4, // (dance_4.msa)
		NAME_DANCE_5, // (dance_5.msa)
		NAME_DANCE_6, // (dance_6.msa) 강남스타일
