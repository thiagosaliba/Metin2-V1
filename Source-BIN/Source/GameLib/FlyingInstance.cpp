...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
			rem.CreateEffectInstance(aei.dwEffectInstanceIndex, dwCRC, 1.0f, NULL, m_dwSkillColor);
#else
...
#ifdef ENABLE_SKILL_COLOR_SYSTEM
	rkEftMgr.CreateEffectInstance(dwEmptyIndex, m_pData->m_dwBombEffectID, 1.0f, NULL, m_dwSkillColor);
#else
