	...
	if NEW_678TH_SKILL_ENABLE:
		SKILL_INDEX_DICT = {
			JOB_WARRIOR : {
				...
				"SUPPORT" : (0, 0, 121, 134, 133, 129, 130, 131, 123, 124, 122, 132, 0, 0, 0, 0, 0, 0)
			},
			JOB_ASSASSIN : {
...
def __InitData():
	...
	chrmgr.RegisterCacheEffect(chrmgr.EFFECT_MAGIC_RING_EQUIP, "", "d:/ymir work/effect/etc/buff/buff_item5.mse")
	...
	if app.ENABLE_GUILD_DRAGONLAIR_SYSTEM:
		...
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_2, "", "d:/ymir work/effect/monster2/redd_moojuk.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_3, "", "d:/ymir work/effect/monster2/redd_moojuk_blue.mse")
		chrmgr.RegisterEffect(chrmgr.EFFECT_DRAGONLAIR_STONE_UNBEATABLE_4, "", "d:/ymir work/effect/monster2/redd_moojuk_green.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_NAZAR_PENDANT, "", "D:/ymir work/effect/etc/buff/buff_item13.mse")
	chrmgr.RegisterEffect(chrmgr.EFFECT_GUARDIAN_PENDANT, "", "D:/ymir work/effect/etc/buff/buff_item14.mse")
...
def __LoadGameEffect():
	...
	if app.ENABLE_CONQUEROR_LEVEL:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_CHEONUN, "", "d:/ymir work/pc/shaman/effect/chunwoon_4_target.mse") ## 무당 - 천운
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+chr.AFFECT_CHUNWOON, "Bip01", "d:/ymir work/pc/shaman/effect/chunwoon_moojuk.mse")
