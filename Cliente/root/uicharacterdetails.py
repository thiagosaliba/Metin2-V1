...
class CharacterDetailsUI(ui.ScriptWindow):
	...
	def __Initialize(self):
		...
		if app.ENABLE_ELEMENT_ADD:
			self.InfoList.append([localeInfo.DETAILS_30, localeInfo.DETAILS_TOOLTIP_30, item.GetApplyPoint(item.APPLY_ENCHANT_ELEC)])
		...
		if app.ENABLE_ELEMENT_ADD:
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_SWORD, localeInfo.DETAILS_TOOLTIP_ATTBONUS_SWORD, item.GetApplyPoint(item.APPLY_RESIST_SWORD_REDUCTION)])
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_TWOHAND, localeInfo.DETAILS_TOOLTIP_ATTBONUS_TWOHAND, item.GetApplyPoint(item.APPLY_RESIST_TWOHAND_REDUCTION)])
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_DAGGER, localeInfo.DETAILS_TOOLTIP_ATTBONUS_DAGGER, item.GetApplyPoint(item.APPLY_RESIST_DAGGER_REDUCTION)])
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_BELL, localeInfo.DETAILS_TOOLTIP_ATTBONUS_BELL, item.GetApplyPoint(item.APPLY_RESIST_BELL_REDUCTION)])
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_FAN, localeInfo.DETAILS_TOOLTIP_ATTBONUS_FAN, item.GetApplyPoint(item.APPLY_RESIST_FAN_REDUCTION)])
			self.InfoList.append([localeInfo.DETAILS_ATTBONUS_BOW, localeInfo.DETAILS_TOOLTIP_ATTBONUS_BOW, item.GetApplyPoint(item.APPLY_RESIST_BOW_REDUCTION)])
			if not app.DISABLE_WOLFMAN_CREATION:
				self.InfoList.append([localeInfo.DETAILS_ATTBONUS_CLAW, localeInfo.DETAILS_TOOLTIP_ATTBONUS_CLAW, item.GetApplyPoint(item.APPLY_RESIST_CLAW_REDUCTION)])
		self.InfoList.append(["", "", self.CATEGORY_ENDLINE])
