...
class CardsInfoWindow(ui.ScriptWindow):
	...
	def __OnStartQuestion(self):
		...
		questionDialog.SetText(localeInfo.MINI_GAME_RUMI_START_QUESTION % (3000, 1))
...
class CardsWindow(ui.ScriptWindow):
	...
	def LoadWindow(self):
		try:
			...
			import exception
			exception.Abort("CardsWindow.LoadDialog.LoadScript")
		...
		try:
			...
			import exception
			exception.Abort("CardsWindow.LoadDialog.BindObject")
	...
	def __EndGame(self):
		questionDialog = uiCommon.QuestionDialog()
		questionDialog.SetText(localeInfo.MINI_GAME_RUMI_EXIT_QUESTION)
...
class IngameWindow(ui.ScriptWindow):
	def __init__(self):
		ui.ScriptWindow.__init__(self)
		self.SetWindowName("IngameWindow")
	...
	def LoadWindow(self):
		try:
			...
			import exception
			exception.Abort("IngameWindow.LoadDialog.LoadScript")
		...
		try:
			...
			import exception
			exception.Abort("IngameWindow.LoadDialog.BindObject")
