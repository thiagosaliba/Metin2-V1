				...
				## bg
				{
					...
					(
						## sub slot
						{
							...
							"slot" : (
								{"index":SLOT_INDEX_WEAPON,		"x":83-BG_START_X,	"y":48-BG_START_Y,	"width":32, "height":32},	# 상( 무기 )
								{"index":SLOT_INDEX_ELEMENT,	"x":83-BG_START_X,	"y":162-BG_START_Y,	"width":32, "height":32},	# 하( 엘리멘탈 )
								{"index":SLOT_INDEX_ARMOR,		"x":26-BG_START_X,	"y":105-BG_START_Y,	"width":32, "height":32},	# 좌( 방어구 )
								{"index":SLOT_INDEX_ACCE,		"x":140-BG_START_X,	"y":105-BG_START_Y,	"width":32, "height":32},	# 우( 액세서리 )
							),
						},
						## passive job up slot
						{
