...
class PrivateShopDialog(ui.ScriptWindow):
	...
	def Refresh(self):
		...
		for i in xrange(shop.SHOP_SLOT_COUNT):
			...
			if app.ENABLE_EXTENDED_BLEND_AFFECT:
				if osfInfo.IS_EXTENDED_BLEND_POTION(getItemID(i)):
					self.ItemSlotWnd1.SetSlotCoverImage(i, "d:/ymir work/ui/acce/ingame_convert_mark_02.tga")
				elif osfInfo.IS_BLEND_POTION(getItemID(i)):
					self.ItemSlotWnd1.SetSlotCoverImage(i, "icon/item/trade.tga")
				else:
					self.ItemSlotWnd1.EnableSlotCoverImage(i, False)
		...
		for i in xrange(shop.SHOP_SLOT_COUNT):
			...
			if app.ENABLE_EXTENDED_BLEND_AFFECT:
				if osfInfo.IS_EXTENDED_BLEND_POTION(getItemID(idx)):
					self.ItemSlotWnd2.SetSlotCoverImage(i, "d:/ymir work/ui/acce/ingame_convert_mark_02.tga")
				elif osfInfo.IS_BLEND_POTION(getItemID(idx)):
					self.ItemSlotWnd2.SetSlotCoverImage(i, "icon/item/trade.tga")
				else:
					self.ItemSlotWnd2.EnableSlotCoverImage(i, False)
