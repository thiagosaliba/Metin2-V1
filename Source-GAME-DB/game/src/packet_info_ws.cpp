...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_PHASE, sizeof(TPacketCGPhase), "Phase", false);
	...
	Set(HEADER_CG_PET_NAME, sizeof(TPacketCGRequestPetName), "RequestPetName", true);
#endif
#ifdef __MAILBOX_SYSTEM__
	Set(HEADER_CG_MAILBOX_SEND, sizeof(TPacketCGMailBoxSend), "MailBoxSend", true);
#endif
	...
	Set(HEADER_CG_SHOP_SEARCH, sizeof(TPacketCGShopSearch), "ShopSearch", true);
	Set(HEADER_CG_SHOP_SEARCH_SUB, sizeof(TPacketCGShopSearch), "ShopSearchSub", true);
	Set(HEADER_CG_SHOP_SEARCH_BUY, sizeof(TPacketCGShopSearchBuy), "ShopSearchBuy", true);
#endif
#ifdef __WARP_TO_VILLAGE_HOT_KEY__
	Set(HEADER_CG_WARP_TO_VILLAGE, sizeof(TPacketCGWarpToVillage), "WarpToVillage", true);
#endif
