...
bool CShipDefense::SpawnRegen(const char* c_szFileName, bool bOnce)
{
	...
	return regen_do(c_szFileName, m_lMapIndex, c_lpSectreeMap->m_setting.iBaseX, c_lpSectreeMap->m_setting.iBaseY, false, bOnce);
}
